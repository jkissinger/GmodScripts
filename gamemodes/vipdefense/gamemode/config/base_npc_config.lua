...
vipd_npcs[ "npc_tf2_ghost" ] = { name = "Ghost", value = 1, teamname = "do_not_use" }

-- ============
-- = Citizens =
-- ============
vipd_npcs[ "npc_citizen" ] = { name = "Citizen", value = 1, teamname = VipdAllyTeam.name }
vipd_npcs[ "Refugee" ] = { name = "Refugee", value = 2, teamname = VipdAllyTeam.name }
vipd_npcs[ "Rebel" ] = { name = "Rebel", value = 4, teamname = VipdAllyTeam.name }
vipd_npcs[ "Medic" ] = { name = "Medic", value = 3, teamname = VipdAllyTeam.name }

-- ========
-- = VIPs =
-- ========
vipd_npcs[ "npc_mossman" ] = { value = 5, teamname = VipdVipTeam.name }
vipd_npcs[ "npc_kleiner" ] = { value = 5, teamname = "do_not_use" }--VipdVipTeam.name }
vipd_npcs[ "npc_gman" ] = { value = 5, teamname = "do_not_use" }
vipd_npcs[ "npc_breen" ] = { value = 5, teamname = "do_not_use" }--VipdVipTeam.name }
vipd_npcs[ "npc_dog" ] = { value = 5, teamname = "do_not_use" }--VipdVipTeam.name }
vipd_npcs[ "npc_eli" ] = { value = 5, teamname = "do_not_use" }--VipdVipTeam.name }
vipd_npcs[ "npc_alyx" ] = { value = 5, teamname = "do_not_use" }--VipdVipTeam.name }
vipd_npcs[ "npc_barney" ] = { value = 5, teamname = VipdVipTeam.name }
vipd_npcs[ "npc_monk" ] = { value = 5, teamname = VipdVipTeam.name }
