...
include("level_system/stats.lua")
...
concommand.Add("vipd_tpcp", TeleportToCheckpoint, nil, "Teleport player to a manually chosen checkpoint")
concommand.Add("vipd_setcp", SetVplyCheckpoint, nil, "Set a checkpoint")
